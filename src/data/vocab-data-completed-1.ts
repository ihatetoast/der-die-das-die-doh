...
export const VOCAB_COMPLETED_1: VocabEntry[] = [
  {
    id: 1,
    eng: "time",
    article: "die",
  ...
  },
  {
    ...
    weakMasculine: false,
    notes: {
      compoundWords: `Decades: Dreißigerjahre (thirties) 30er Jahre / 30-Jahre (30s), \nSiebzigerjahre (sixties) 60er Jahre / 60-Jahre (60s), etc `,
      pluralNote:
        "Most neuter nouns take the -e plural form. It's a good bet when in doubt.",
      miscNote: `Expressions/idioms: "Das verflixte siebte Jahr" (lit. the cursed seventh year) - the seven-year itch\n
      "in die Jahre kommen" (come into the years) - to get on in years, to become outdated`,
    },
    sentences: [
      {
        de: "Das Jahr neigt sich am Ende zu.",
  ...
  },
  {
    ...
    weakMasculine: false,
    notes: {
      miscNote: `Expressions/idioms: "das Zimmer hüten" (lit. to guard the room) - to stay in bed because you're sick\n
      "Geh auf dein Zimmer!" (lit. go onto your room) - Go to your room (a parental favourite)\n
      "Diese Zimmer stehen Ihnen zur Verfügung" (lit. these rooms stand to you to the disposal) - These rooms are available for you to use / for your disposal.`,
      compoundWords:
  ...
  },
  {
    ...
    notes: {
      pluralNote:
        "Most feminine nouns that are monosyllabic with an a or u (and some t sound) add ¨-e",
      miscNote: `"nicht vor meiner Tür!" (lit. not in front of my door) - not in my backyard / NIMBY \n
      "Mach di Tür von außen zu" (lit. close your door from the outside) - Don't let hte door hit you on the way out!\n
      "bei jemandem offene Türen einrennen - (lit. to run into someone's open doors) - to preach to the converted (UK) / to the choir (US)`,
      compoundWords:
    ...
    sentences: [
      ...
      {
        de: "Die Wände haben Ohren, die Türen haben Augen.",
        en: "The walls have ears, the doors have eyes.",
        case: "nom",
      },
    ],
    themes: ["buildings", "home"],
  ...
  },
  {
    ...
    weakMasculine: false,
    notes: {
      miscNote: `"Wenn das Wörtchen 'wenn' nicht wär, wär mein Vater Millionär" - If wishes were horses, beggars would ride / If ifs and ands were pots and pans, there'd be no work for tinkers \n
      Wie der Vater, so der Sohn - Like father, like son`,
      pluralNote:
        "Belongs to a small, predictable group of masculine and neuter nouns ending in -er, -el, or -en that take no extra plural ending, but change their base vowel into an umlaut",
      compoundWords:
        "Stiefvater (stepfather), Großvater (grandfather), Schwiegervater (father-in-law),Göttervater (godfather)",
    },
    sentences: [
      {
  ...
  },
  {
    ...
    notes: {
      compoundWords:
        "Silberrücken (silverback / older male gorilla), Rundrücken (hunchback)",
      miscNote: `"jemandem in den Rücken fallen" (lit. to fall on someone's back) - to backstab someone / to stab someone in the back\n
"jemandem den Rücken stärken" (lit. to strengthen someone's back) - to have someone's back.`,
    },
    sentences: [
      {
        de: "Ich liege auf dem Rücken und schaue den Wolken zu.",
        en: "I lie on my back and watch the clouds.",
        case: "dat",
      },
      {
        de: "Er gab mir einen Klaps auf den Rücken.",
        en: "He cuffed/patted/slapped me on the back.",
        case: "acc",
      },
    ],
    themes: ["body"],
  ...
  },
  {
    ...
    sentences: [
      ...
      {
        de: "Michel hatte eine tiefe Stimme.",
        en: "Michel has a deep voice.",
        case: "acc",
      },
    ],
    themes: ["body", "art"],
  ...
  },
  {
    ...
    sentences: [
      ...
      {
        de: "Er hat kurze Arme.",
        en: "He has short arms.",
        case: "acc",
      },
    ],
    themes: ["body"],
  ...
  },
  {
    ...
    sentences: [
      {
        de: "Ihr Kopf lag auf dem Tisch.",
        en: "Her head lay on the table.",
        case: "dat",
      },
      {
  ...
  },
  {
    ...
    weakMasculine: false,
    notes: {
      compoundWords: `Pattern: Freitagmogen (Friday morning), Sonntagmorgen (Sunday morning)`,
      miscNote: `Expressions/idioms: "Frühflug am Morgen" (lit. early flight in the morning) - red-eye flight
      "Was du heute kannst besorgen, das verschiebe nicht auf morgen." (lit. What you can do today, don't put off until tomorrow / There's no time like the present)`,
    },
    sentences: [
      {
  ...
  },
  {
    ...
    sentences: [
      ...
      {
        de: "Die Treppe ist am Ende des Flurs.",
        en: "The stairs are at the end of the corridor.",
        case: "dat",
      },
    ],
    themes: ["misc"],
  ...
  },
  {
    ...
    notes: {
      ...
      otherEngDefinitions: "type, character, bloke, dude, model, version",
    },
    sentences: [
      {
  ...
  },
  {
    ...
    weakMasculine: false,
    notes: {
      pluralNote: "Adding -(e)n is very common with feminine nouns.",
      miscNote: `Expressions/idioms: "24 Stunden am Tag, sieben Tage die Woche" - 24/7\n
      "Unter der Woche" (lit. Under the week) - During the work week\n
      "Alle zwei Wochen" (lit. All two weeks) - Every other week / Every two weeks`,
      compoundWords: `Flitterwochen (in plural, honeymoon), `,
    },
    sentences: [
  ...
  },
  {
    ...
    notes: {
      pluralNote: "Adding -(e)n is very common with feminine nouns.",
      miscNote: `Expressions/idioms: "Arbeit allein macht nicht glücklich" (lit. Work alone does not make happy) - All work and no play makes Jack a dull boy\n
      "Erst die Arbeit, dann das Vergnügen" (lit. First the work, then the pleasure) - Business before pleasure`,
      compoundWords: `Hausarbeit (housework), Gruppenarbeit (group work)`,
    },
    sentences: [
      {
...

  {
    ...
    sentences: [
      {
        de: "Beate ist im Krankenhaus.",
        en: "Beate is in (the) hospital",
        case: "dat",
      },
      {
        de: "Sie fürchtet Krankenhäuser.",
        en: "She fears hospitals.",
        case: "acc",
      },
    ],
    themes: ["misc"],
...

  {
    ...
    notes: {
      genderNote:
        "Words ending in -ling as well as seasons are usually masculine.",
    },
    sentences: [
      {
        de: "Der Frühling ist eine freundliche Jahreszeit.",
        en: "Spring is a delightful season",
        case: "nom",
      },
      {
        de: "Wir sind am Anfang des Frühlings.",
        en: "We're at the beginning of spring.",
        case: "gen",
      },
    ],
    themes: ["time", "weather"],
  ...
  },
  {
    ...
    sentences: [
      { de: "Mach den Motor aus!", en: "Turn off the engine!", case: "acc" },
      {
        de: "Vor der Küste sind bei einem starken Sturm die Motoren ausgefallen.",
        en: "Off the coast, the engines failed during a strong storm.",
        case: "nom",
      },
    ],
    themes: ["misc"],
...

  {
    ...
    sentences: [
      {
        de: "Der Tango ist ein beliebter Tanz aus Argentinien.",
        en: "The tango is a popular dance from Argentina.",
        case: "nom",
      },
      {
        de: "Zu den schwersten Tänzen gehören der Walzer und das Ballett",
        en: "The hardest dances include the waltz and ballet.",
        case: "dat",
      },
    ],
    themes: ["misc"],
  ...
  },
  {
    ...
    notes: {
      miscNote:
        "Zeitgeist (spirit of the age), Poltergeist (noisy mischievous ghost), Mannschaftsgeist (team spirit), Sportgeist (sportsmanship).",
    },
    sentences: [
      {
        de: "Die Schreibfeder ist die Zunge des Geistes",
        en: "The pen is the tongue of the spirit.",
        case: "gen",
      },
      {
        de: "Glaubst due an Geister?",
  ...
  },
  {
    ...
    sentences: [
      ...
      {
        de: "Alle Blicke waren auf sie gerichtet.",
  ...
  },
  {
    ...
    sentences: [
      {
        de: "Abschiede sind immer traurig.",
        en: "Goodbyes are always sad.",
        case: "nom",
      },
      {
        de: "Stefan winkte mir zum Abschied.",
        en: "Stefan waved goodbye to me.",
        case: "dat",
      },
    ],
    themes: ["misc"],
  ...
  },
  {
    ...
    notes: { weakMascHint: "Exceptions: add '-n' and not '-en'" },
    sentences: [
      {
  ...
  },
  {
    ...
    notes: {
      miscNote: `Words with "Tourist" in English but not in German: Reiseleiter/in (tourist/tour guide), Ausflugsziel (tourist attraction) `,
      genderNote:
...

  {
    ...
    weakMasculine: false,
    notes: {
      otherGerDefinitions: "das Plakat",
      miscNote: `Poster for notice boards and Plakat for bands or stars`,
    },
    sentences: [
      {
  ...
  },
  {
    ...
    weakMasculine: false,
    notes: {
      genderNote: `Nominalized infinitives (ex das Essen, das Kochen) are always neuter,\n
      but if they are derived from verb roots, they are often other genders (ex die Arbeit from arbeiten, der Flug from fliegen/flug)`,
      otherEngDefinitions: "boiling, bubbling",
    },
  ...
  },
  {
    ...
    notes: {
      miscNote: "Use 'direkt' to mean 'nextdoor': direkte Nachbarin.",
    },
    sentences: [
      {
  ...
  },
  {
    ...
    notes: {
      miscNote:
        "Often the term 'farmer's wife' is used, but this is old fashioned and assumes she has no role in farming.",
      genderNote:
        "The male form for farmer is Bauer and not Bäuer. Note the ä!",
    },
    sentences: [
      {
        de: "Meine Oma war Bäuerin.",
        en: "My grandma was a farmer.",
        case: "nom",
      },
      {
...

  {
    ...
    notes: {
      otherEngDefinitions: "colossus",
    },
    sentences: [
      {
        de: "Fenja ist eine Riesin der nordischen Mythologie.",
        en: "Fenja is a giantess of Norse mythology.",
        case: "nom",
      },
      {
        de: "In vielen alten Sagen werden die Riesinnen als mächtige Beschützerinnen der Berge beschrieben.",
        en: "In many ancient legends, the giantesses are described as powerful protectors of the mountains.",
        case: "nom",
      },
    ],
    themes: ["people", "fantasy"],
