...
export const VOCAB_3: VocabEntry[] = [
{
  ...
  },
  {
    ...
    weakMasculine: false,
    notes: {
      pluralNote: 'Usually uncountable, but when referring to different rice types, the plural is used.',
    },
    sentences: [
      { de: 'SATZ1', en: 'SENTENCE1', case: 'nom' },
      { de: 'SATZ2', en: 'SENTENCE2', case: 'acc' },
  ...
  },
  {
    ...
    weakMasculine: false,
    notes: {
      miscNote:"Aktenkoffer can also mean 'attaché case'. It is a higher level of security and usually has a hard shell. Aktentashe is softer, often leather.",
    },
    sentences: [
      { de: 'SATZ1', en: 'SENTENCE1', case: 'nom' },
      { de: 'SATZ2', en: 'SENTENCE2', case: 'acc' },
